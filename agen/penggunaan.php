          ...
          <div class="container" style="margin-top: 70px; padding-bottom: 50px;" >
            <div class="row">
              <div class="col s12">
                ...
                <div class="row">
                  <div class="input-field col s5">
                    <input type="text" name="i5" readonly class="validate" placeholder="" value="<?php echo @$meter  ?>">
                    <label for="">Meter Awal</label>
                  </div>

                  <div class="input-field col s5">
                    <input type="text" name="i6" class="validate" onkeypress="return event.charCode >=48 && event.charCode <=57" placeholder="" value="<?php @$edit[0];?>">
